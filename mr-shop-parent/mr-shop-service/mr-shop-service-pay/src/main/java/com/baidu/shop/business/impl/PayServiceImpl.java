...
public class PayServiceImpl extends BaseApiService implements PayService {
    ...
    @Override
    public void returnURL(HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest) {
        //获取支付宝GET过来反馈信息
	...
	*/
    ...
    public void requestPay(PayInfoDTO payInfoDTO, HttpServletResponse httpServletResponse) {
       ...
       /* //获得初始化的AlipayClient
        ...
        Result<OrderInfo> infoResult = orderFeign.getOrderInfoByOrderId(payInfoDTO.getOrderId());
        if (infoResult.getCode() == 200) {

            OrderInfo orderInfo = infoResult.getData();
//            List<String> collect = orderInfo.getOrderDetailList().stream().map(orderDetailEntity ->
//                    orderDetailEntity.getTitle()
